...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_foreign_key "recording_first_release_date", "recording", column: "recording", name: "recording_first_release_date_fk_recording", on_delete: :cascade
  ...
  add_foreign_key "release_first_release_date", "release", column: "release", name: "release_first_release_date_fk_release", on_delete: :cascade
